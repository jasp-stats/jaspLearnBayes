...
LSgameofskill   <- function(jaspResults, dataset, options, state = NULL){
  ...
  summaryTable$dependOn(c("players", "numberOfSimulatedGames", "pointsToWin", "ci"))
  ...
  ciPlot$dependOn(c("players", "numberOfSimulatedGames", "pointsToWin", "ci"))
  ...
  if (nPlayers == 2 && max(xPoints) < pointsToWin){
    ...
    result <- compareSkillTwoPlayers(xPoints[1],xPoints[2],pointsToWin,priorSkill[1],priorSkill[2],numberOfSimulatedGames)
    ...
    result <- compareSkillNPlayers(xPoints, pointsToWin, priorSkill, numberOfSimulatedGames)
    ...
    for (i in 1:length(xPoints)){
      ...
      Analytical_Prob[i] <- compareSkillNPlayers(xPoints_copy, pointsToWin, priorSkill_copy, numberOfSimulatedGames)[[2]]
    }
